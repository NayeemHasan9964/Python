...
#Write a function that returns the list of string
# def loves_me_not(n):
#     x = list()
...
#write a function to repeat vowels twice in String
# def repeat_vowels(s):
#     vowels = 'aeiouAEIOU'
...
#Write a function that takes floating number and return reverse of that number
# def reverse_number(num):
